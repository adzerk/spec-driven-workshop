...
jml:
	...
	# This next line is useful when trying to analyze a single file:
	#@tooling/openjml/openjml --esc --progress -cp "target/classes:$(cat target/jml-classpath.txt)" src/main/java/com/kevel/util/BL.java
